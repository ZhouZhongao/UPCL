...
_C.MODEL.DIRECT = 1
_C.MODEL.USE_CLUSTER = 0
_C.MODEL.USE_SPE = 0
_C.MODEL.SPE_COE = 1.0
_C.MODEL.USE_CROSS = 0
_C.MODEL.USE_UNBIASED = 0
_C.MODEL.CROSS_COE = 1.0
_C.MODEL.UNBIASED_COE = 0.1
_C.MODEL.TEMP = 0.05
_C.MODEL.MOMENTUM = 0.1
_C.MODEL.USE_FINCH = 0
_C.MODEL.FINCH_COE = 1.0
_C.MODEL.USE_DYNAMIC = 0
# Transformer setting
